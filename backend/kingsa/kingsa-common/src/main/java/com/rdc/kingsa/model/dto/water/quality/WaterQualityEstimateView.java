...
@ApiModel("干流水质评价信息-保存")
public class WaterQualityEstimateView {
	...
	@ApiModelProperty("ph值类别")
	@NotNull(message = "ph值类别不能为空")
	@Range(min = 0, max = 9, message = "ph值类别必须在{min}与{max}之间")
	private Short phT;

	@ApiModelProperty("溶解氧类别")
	@NotNull(message = "溶解氧类别不能为空")
	@Range(min = 0, max = 9, message = "溶解氧类别必须在{min}与{max}之间")
	private Short disOxygenT;

	@ApiModelProperty("高锰酸盐类别")
	@NotNull(message = "高锰酸盐类别不能为空")
	@Range(min = 0, max = 9, message = "高锰酸盐类别必须在{min}与{max}之间")
	private Short permanganateT;

	@ApiModelProperty("化学需氧量类别")
	@NotNull(message = "化学需氧量类别不能为空")
	@Range(min = 0, max = 9, message = "化学需氧量类别必须在{min}与{max}之间")
	private Short oxDemandT;

	@ApiModelProperty("五日生化需氧量类别")
	@NotNull(message = "五日生化需氧量类别不能为空")
	@Range(min = 0, max = 9, message = "五日生化需氧量类别必须在{min}与{max}之间")
	private Short boDemandT;

	@ApiModelProperty("氨氮类别")
	@NotNull(message = "氨氮类别不能为空")
	@Range(min = 0, max = 9, message = "氨氮类别必须在{min}与{max}之间")
	private Short ammoniaT;

	@ApiModelProperty("总磷类别")
	@NotNull(message = "总磷类别不能为空")
	@Range(min = 0, max = 9, message = "总磷类别必须在{min}与{max}之间")
	private Short phosphorusT;

	@ApiModelProperty("铜类别")
	@NotNull(message = "铜类别不能为空")
	@Range(min = 0, max = 9, message = "铜类别必须在{min}与{max}之间")
	private Short copperT;

	@ApiModelProperty("锌类别")
	@NotNull(message = "锌类别不能为空")
	@Range(min = 0, max = 9, message = "锌类别必须在{min}与{max}之间")
	private Short zincT;

	@ApiModelProperty("氟化物类别")
	@NotNull(message = "氟化物类别不能为空")
	@Range(min = 0, max = 9, message = "氟化物类别必须在{min}与{max}之间")
	private Short fluorideT;

	@ApiModelProperty("硒类别")
	@NotNull(message = "硒类别不能为空")
	@Range(min = 0, max = 9, message = "硒类别必须在{min}与{max}之间")
	private Short seleniumT;

	@ApiModelProperty("砷类别")
	@NotNull(message = "砷类别不能为空")
	@Range(min = 0, max = 9, message = "砷类别必须在{min}与{max}之间")
	private Short arsenicT;

	@ApiModelProperty("汞类别")
	@NotNull(message = "汞类别不能为空")
	@Range(min = 0, max = 9, message = "汞类别必须在{min}与{max}之间")
	private Short mercuryT;

	@ApiModelProperty("镉类别")
	@NotNull(message = "镉类别不能为空")
	@Range(min = 0, max = 9, message = "镉类别必须在{min}与{max}之间")
	private Short cadmiumT;

	@ApiModelProperty("六价铬类别")
	@NotNull(message = "六价铬类别不能为空")
	@Range(min = 0, max = 9, message = "六价铬类别必须在{min}与{max}之间")
	private Short chromiumT;

	@ApiModelProperty("铅类别")
	@NotNull(message = "铅类别不能为空")
	@Range(min = 0, max = 9, message = "铅类别必须在{min}与{max}之间")
	private Short leadT;

	@ApiModelProperty("氰化物类别")
	@NotNull(message = "氰化物类别不能为空")
	@Range(min = 0, max = 9, message = "氰化物类别必须在{min}与{max}之间")
	private Short cyanideT;

	@ApiModelProperty("挥发酚类别")
	@NotNull(message = "挥发酚类别不能为空")
	@Range(min = 0, max = 9, message = "挥发酚类别必须在{min}与{max}之间")
	private Short phenolT;

	@ApiModelProperty("石油类类别")
	@NotNull(message = "石油类类别不能为空")
	@Range(min = 0, max = 9, message = "石油类类别必须在{min}与{max}之间")
	private Short petroleumT;

	@ApiModelProperty("阴离子表面活性剂类别")
	@NotNull(message = "阴离子表面活性剂类别不能为空")
	@Range(min = 0, max = 9, message = "阴离子表面活性剂类别必须在{min}与{max}之间")
	private Short surfactantT;

	@ApiModelProperty("硫化物类别")
	@NotNull(message = "硫化物类别不能为空")
	@Range(min = 0, max = 9, message = "硫化物类别必须在{min}与{max}之间")
