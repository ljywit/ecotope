...
import com.rdc.kingsa.input.server.service.base.StaticService;
...
public class KingsaController {
    ...
    @ApiOperation(value = "审批信息获取", httpMethod = "POST", produces = "application/json;charset=utf-8")
    ...
    public GetMonitorReportOt getMonitorReport(@ApiParam("入参") @Valid @RequestBody GetMonitorReportIt input,
                                               BindingResult bindingResult) throws Exception {
        return monitorService(input.getType()).getBaseMsgDetail(input);
    }
    ...
    @RequestMapping(value = "/kingsa:save-monitor-report", method = RequestMethod.POST, produces = {
            MediaType.APPLICATION_JSON_VALUE}, consumes = {MediaType.APPLICATION_JSON_VALUE})
    public void saveMonitorReport(@ApiParam("入参") @Valid @RequestBody CreateMonitorReportIt input,
                                  BindingResult bindingResult) throws Exception {
        monitorService(input.getType()).createBaseMsg(input);
    }
    ...
    @RequestMapping(value = "/kingsa:delete-monitor-report", method = RequestMethod.POST, produces = {
            MediaType.APPLICATION_JSON_VALUE}, consumes = {MediaType.APPLICATION_JSON_VALUE})
    public void deleteMonitorReport(@ApiParam("入参") @Valid @RequestBody DeleteMonitorReportIt input,
                                    BindingResult bindingResult) throws Exception {
        monitorService(input.getType()).deleteBaseMsgs(input);
    }
    ...
    @RequestMapping(value = "/kingsa:update-monitor-report", method = RequestMethod.POST, produces = {
            MediaType.APPLICATION_JSON_VALUE}, consumes = {MediaType.APPLICATION_JSON_VALUE})
    public void updateMonitorReport(@ApiParam("入参") @Valid @RequestBody UpdateMonitorReportIt input,
                                    BindingResult bindingResult) throws Exception {
        monitorService(input.getType()).updateBaseMsg(input);
    }

    @ApiOperation(value = "监测记录临时表列表查询", httpMethod = "POST", produces = "application/json;charset=utf-8")
    ...
    public GetMonitorReportFCListOt getMonitorReportFCList(@ApiParam("入参") @Valid @RequestBody GetMonitorReportFCListIt input,
                                                           BindingResult bindingResult) throws Exception {
        return monitorService(input.getType()).getFCDataList(input);
    }
    ...
    public GetMonitorReportFCDetailOt getMonitorReportFC(@ApiParam("入参") @Valid @RequestBody GetMonitorReportFCDetailIt input,
                                                         BindingResult bindingResult) throws Exception {
        return monitorService(input.getType()).getFCDataDetail(input);
    }
    ...
    @RequestMapping(value = "/kingsa:update-monitor-report-fc", method = RequestMethod.POST, produces = {
            MediaType.APPLICATION_JSON_VALUE}, consumes = {MediaType.APPLICATION_JSON_VALUE})
    public void updateMonitorReportFC(@ApiParam("入参") @Valid @RequestBody UpdateMonitorReportFCIt input,
                                      BindingResult bindingResult) throws Exception {
        monitorService(input.getType()).updateFCData(input);
    }
    ...
    public void saveMonitorReportFC(@ApiParam("入参") @Valid @RequestBody CreateMonitorReportFCIt input,
                                    BindingResult bindingResult) throws Exception {
        monitorService(input.getType()).createFCData(input);
    }
    ...
    public void deleteMonitorReportFC(@ApiParam("入参") @Valid @RequestBody DeleteMonitorReportFCIt input,
                                      BindingResult bindingResult) throws Exception {
        monitorService(input.getType()).deleteFCDatas(input);
    }
    ...
    public void deleteMonitorReportFC(@ApiParam("入参") @Valid @RequestBody EmptyMonitorReportFCIt input,
                                      BindingResult bindingResult) throws Exception {
        monitorService(input.getType()).emptyFCDatas(input);
    }
